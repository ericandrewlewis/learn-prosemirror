...
var _typeof77 = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol ? "symbol" : typeof obj; };
...
var ColorBlock = function (_Block) {
  _inherits(ColorBlock, _Block);

  function ColorBlock() {
    _classCallCheck(this, ColorBlock);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(ColorBlock).apply(this, arguments));
  }

  _createClass(ColorBlock, [{
    key: "serializeDOM",
    value: function serializeDOM(node, serializer) {
      var ele = (0, _dom.elt)("div", {
    ...
    get: function get() {
      return {
        position: new _model.Attribute({ default: "red" })
      };
    }
  }, {
    key: "draggable",
...
},{"prosemirror/dist/dom":2,"prosemirror/dist/model":35}],59:[function(require,module,exports){
"use strict";
...
var _customNode = require("./custom-node");
...
var customSchema = new _model.Schema(_model.defaultSchema.spec.update({ color_block: _customNode2.default }));
...
// To insert the block...
// pm.tr.replaceSelection(pm.schema.nodes.color_block.create()).apply()

},{"./custom-node":58,"prosemirror/dist/edit":12,"prosemirror/dist/inputrules/autoinput":26,"prosemirror/dist/menu/menubar":30,"prosemirror/dist/menu/tooltipmenu":31,"prosemirror/dist/model":35}]},{},[59]);
